...
These are still in log odds units, so you can calculate the probability using the same $ p = \dfrac{e}{1 + e}$ method. For example, the estimated probability of a consequentialist decision in the real group is:
