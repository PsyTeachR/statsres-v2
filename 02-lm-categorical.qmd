...
3. Create a new R Markdown document and give it a sensible title describing the chapter, such as `02 t-tests and Regression`. Save the file in your `02_regression_categorical` folder. 
